...
Volumetric muscle loss (VML), the traumatic or surgical removal of skeletal muscle beyond the point of natural regeneration, results in severe, permanent functional impairment groganVolumetricMuscleLoss2011. Current clinical treatments for VML, such as physical therapy or autologous tissue transfer, have limited efficacy in restoring pre-injury muscle strength and function, often with the drawback of donor site morbidity [@AmitAurora-etal-2014; @garg]( Garg et al., 2015). This clinical gap has spurred significant preclinical research into regenerative strategies. These approaches often involve biomaterial scaffolds [@Grasman-etal-2015; @Passipieri-etal-2017], injectable hydrogels [@Wu-etal-2012], cell-based therapies, and adjunctive treatments like exercise [@coronaContributionMincedMuscle2017; @dzikiAcellularBiologicScaffold2016]. One significant effort has focused on the development of a tissue engineered muscle repair (TEMR) construct and its use in treating VML in combination with other biomaterials (Corona et al., 2012, 2013; Machingal et al., 2011).
...
![](images/STP_table.png)

*^, ^^, ^^^ indicates p < 0.05, 0.01, 0Master's.001 respectively compared to NR*
...
```{python}
#| label: fig-nr-kinematics
#| fig-cap: "No Repair group kinematics vs Control at week24"
from scripts.plot_helpers import plot_group_kinematics
plot_group_kinematics("data/processed", group="nr", session="week24")
```
```{python}
#| label: fig-nr-kinetics
#| fig-cap: "No Repair group kinetics vs Control at week24"
from scripts.plot_helpers import plot_group_comparison
plot_group_comparison("data/processed", group_a="nr", group_b="control", session="week24", result_type="id")
```
...
```{python}
#| label: fig-hh-kinematics
#| fig-cap: "Healy Hydrogel group kinematics vs Control at week24"
plot_group_kinematics("data/processed", group="hh", session="week24")
```
```{python}
#| label: fig-hh-kinetics
#| fig-cap: "Healy Hydrogel group kinetics vs Control at week24"
plot_group_comparison("data/processed", group_a="hh", group_b="control", session="week24", result_type="id")
```
...
```{python}
#| label: fig-hs-kinematics
#| fig-cap: "Healy Sponge group kinematics vs Control at week24"
plot_group_kinematics("data/processed", group="hs", session="week24")
```
```{python}
#| label: fig-hs-kinetics
#| fig-cap: "Healy Sponge group kinetics vs Control at week24"
plot_group_comparison("data/processed", group_a="hs", group_b="control", session="week24", result_type="id")
```
...
```{python}
#| label: fig-temr-kinematics
#| fig-cap: "TEMR group kinematics vs Control at week24"
plot_group_kinematics("data/processed", group="temr", session="week24")
```
```{python}
#| label: fig-temr-kinetics
#| fig-cap: "TEMR group kinetics vs Control at week24"
plot_group_comparison("data/processed", group_a="temr", group_b="control", session="week24", result_type="id")
```

#### TEMR and Hydrogel (TEMR+HH)

```{python}
#| label: fig-temr-hh-kinematics
#| fig-cap: "TEMR+HH group kinematics vs Control at week24"
plot_group_kinematics("data/processed", group="temr_hh", session="week24")
```
```{python}
#| label: fig-temr-hh-kinetics
#| fig-cap: "TEMR+HH group kinetics vs Control at week24"
plot_group_comparison("data/processed", group_a="temr_hh", group_b="control", session="week24", result_type="id")
```

#### TEMR and Keratin Gel (TEMR+KG)

```{python}
#| label: fig-temr-kg-kinematics
#| fig-cap: "TEMR+KG group kinematics vs Control at week24"
plot_group_kinematics("data/processed", group="temr_kg", session="week24")
```
```{python}
#| label: fig-temr-kg-kinetics
#| fig-cap: "TEMR+KG group kinetics vs Control at week24"
plot_group_comparison("data/processed", group_a="temr_kg", group_b="control", session="week24", result_type="id")
```
